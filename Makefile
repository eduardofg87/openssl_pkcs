srcdir = /home/php-src/ext/openssl_pkcs
builddir = /home/php-src/ext/openssl_pkcs
top_srcdir = /home/php-src/ext/openssl_pkcs
top_builddir = /home/php-src/ext/openssl_pkcs
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = gawk
shared_objects_openssl_pkcs = openssl_pkcs.lo p7s.lo
PHP_PECL_EXTENSION = openssl_pkcs
PHP_MODULES = $(phplibdir)/openssl_pkcs.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /home/php-src/ext/openssl_pkcs/modules
